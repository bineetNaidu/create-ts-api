...
import { connectDatabase, disconnectDatabase } from '@/lib/db/data-source.js';
...
const bootstrap = async () => {
  ...
  // 2. Build TypeGraphQL Schema with Global PostgreSQL Error Middleware
  ...
  console.log(`🚀  GraphQL + PostgreSQL Server ready at ${url}`);
